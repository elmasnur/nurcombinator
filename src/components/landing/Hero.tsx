  ...
  return (
    <section className="relative overflow-hidden bg-ivory">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -left-32 -top-32 h-[26rem] w-[26rem] rounded-full bg-accent-amber/12 blur-3xl dark:bg-accent-amber/8" />
        <div className="absolute -right-40 top-24 h-[30rem] w-[30rem] rounded-full bg-accent-sky/12 blur-3xl dark:bg-accent-sky/8" />
        <div className="absolute bottom-0 left-1/3 h-[18rem] w-[18rem] rounded-full bg-accent-violet/8 blur-3xl dark:bg-accent-violet/6" />
      </div>
      ...
      <div className="container relative mx-auto grid items-center gap-12 px-4 py-16 md:py-20 lg:grid-cols-12 lg:gap-10 lg:py-28">
        <div className="lg:col-span-7 animate-fade-in">
          ...
          <h1 className="text-display-tight text-balance font-display font-bold leading-[1.02] text-slate-deep text-[2.5rem] sm:text-5xl lg:text-[4.25rem] xl:text-[4.75rem]">
            {head}{' '}
        ...
        <div className="lg:col-span-12 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="surface-premium relative flex items-center gap-3 rounded-2xl border border-border/70 p-4 backdrop-blur shadow-soft-1 dark:border-white/10">
            <span className="font-display text-3xl font-bold leading-none text-slate-deep tabular-nums">24</span>
            <div className="min-w-0">
          ...
          <div className="surface-premium relative flex items-center gap-3 rounded-2xl border border-border/70 p-4 backdrop-blur shadow-soft-1 dark:border-white/10">
            <span className="font-display text-3xl font-bold leading-none text-slate-deep tabular-nums">61</span>
            <div className="min-w-0">
